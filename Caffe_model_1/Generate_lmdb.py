...
Description     :It divides the training images(Leaves) into 2 sets and stores them in lmdb databases for training and validation.
Author          :Nitin Shukla
...
train_lmdb = '/home/ubuntu/DeepLearning_crop_classification/input/LEAVES/train_lmdb'
validation_lmdb = '/home/ubuntu/DeepLearning_crop_classification/input/LEAVES/validation_lmdb'

os.system('rm -rf  ' + train_lmdb)
os.system('rm -rf  ' + validation_lmdb)


df_train = [img for img in glob.glob("/home/ubuntu/DeepLearning_crop_classification/input/LEAVES/Leaves/*jpg")]
# df_test = [img for img in glob.glob("/home/ubuntu/DeepLearning_crop_classification/input/LEAVES/Leaves/*jpg")]
